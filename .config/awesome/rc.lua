...
mymainmenu = awful.menu({ theme = { width = 150 },
...
awful.rules.rules = {
    ...
    { rule = { class = "Steam" },
      properties = { floating = true } },
    { rule = { name = "Minecraft - MyCraft v3.0" },
      properties = { floating = true } },
    { rule = { name = "MyCraft v3.0" },
      properties = { floating = true } },
    { rule = { name = "Minecraft - MyCraft Beta v0.1" },
      properties = { floating = true } },
    { rule = { name = "MyCraft Beta v0.1" },
      properties = { floating = true } },
...
client.connect_signal("manage", function (c, startup)
    ...
    if titlebars_enabled and (c.type == "normal" or c.type == "dialog") then
        -- Widgets that are aligned to the left
        local left_layout = wibox.layout.fixed.horizontal()
        layout_left:add(awful.titlebar.widget.iconwidget(c))
